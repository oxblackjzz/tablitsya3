    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WorkstationEntity>(entity =>
            {
                ...
                entity.Property(e => e.ScannerConnectionType).HasColumnName("scanner_connection_type");
                entity.Property(e => e.ScannerEnabled).HasColumnName("scanner_enabled");
                entity.Property(e => e.ScannerDeviceName).HasColumnName("scanner_device_name");
                entity.Property(e => e.ScannerSerialNumber).HasColumnName("scanner_serial_number");
                entity.Property(e => e.ScannerUsbVid).HasColumnName("scanner_usb_vid");
                entity.Property(e => e.ScannerUsbPid).HasColumnName("scanner_usb_pid");
                entity.Property(e => e.ScannerComPort).HasColumnName("scanner_com_port");
                entity.Property(e => e.ScannerBaudRate).HasColumnName("scanner_baud_rate");
                entity.Property(e => e.ScannerBluetoothMac).HasColumnName("scanner_bluetooth_mac");
                entity.Property(e => e.ScannerIpAddress).HasColumnName("scanner_ip_address");
                entity.Property(e => e.ScannerTcpPort).HasColumnName("scanner_tcp_port");
                entity.Property(e => e.ScannerWebhookUrl).HasColumnName("scanner_webhook_url");
                entity.Property(e => e.ScannerPrefix).HasColumnName("scanner_prefix");
                entity.Property(e => e.ScannerSuffix).HasColumnName("scanner_suffix");
                entity.Property(e => e.ScannerExtraJson).HasColumnName("scanner_extra_json");
                entity.Property(e => e.CreatedDate).HasColumnName("created_date");
                entity.Property(e => e.UpdatedDate).HasColumnName("updated_date");
