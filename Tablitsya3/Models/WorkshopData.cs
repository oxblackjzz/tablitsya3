...
namespace таблиця3.Models
{
    public class WorkshopData
    {
        ...
        [Obsolete("Використовуйте WorkshopCapacities для налаштування потужності кожного цеху")]
        public int DailyCapacity { get; set; } = 1000;
        public int ProductionLeadTime { get; set; } = 5;
        public int DaysBeforeProduction { get; set; } = 1; // ЗМІНЕНО: за замовчуванням 1 день замість 2
    }
}
